...
Abcam (@abcam_western_2023) and Thermo (@thermofisher_western_2023) have protocols in agreement. Phosphosolutions proposes 2mM Tris, 14 mM NaCl. Our group has more experience using the Abcam protocol, which is why it is listed here. Note that there are multiple different approaches to the concentrations when making TBS.
